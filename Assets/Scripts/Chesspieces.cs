...
public class Chesspieces : MonoBehaviour
{
    ...
    public void Activate()
    {
        ...
        switch (this.name)
        {
            case "black_king": this.GetComponent<SpriteRenderer>().sprite = black_king; player = "black"; points=900; break;
            case "black_queen": this.GetComponent<SpriteRenderer>().sprite = black_queen; player = "black"; points =90; break;
            case "black_knight": this.GetComponent<SpriteRenderer>().sprite = black_knight; player = "black"; points =30; break;
            case "black_bishop": this.GetComponent<SpriteRenderer>().sprite = black_bishop; player = "black"; points =30; break;
            case "black_pawn": this.GetComponent<SpriteRenderer>().sprite = black_pawn; player = "black"; points =10; break;
            case "black_rook": this.GetComponent<SpriteRenderer>().sprite = black_rook; player = "black"; points =50; break;

            case "white_king": this.GetComponent<SpriteRenderer>().sprite = white_king; player = "white"; points =900; break;
            case "white_queen": this.GetComponent<SpriteRenderer>().sprite = white_queen; player = "white"; points =90; break;
            case "white_knight": this.GetComponent<SpriteRenderer>().sprite = white_knight; player = "white"; points =30; break;
            case "white_bishop": this.GetComponent<SpriteRenderer>().sprite = white_bishop; player = "white"; points =30; break;
            case "white_pawn": this.GetComponent<SpriteRenderer>().sprite = white_pawn; player = "white"; points =10; break;
            case "white_rook": this.GetComponent<SpriteRenderer>().sprite = white_rook; player = "white"; points =50; break;
    ...
    public void LineMovePlate(int xIncrement, int yIncrement)
    {
        ...
        { 
            ...
            while (sc.PositionOnBoard(x, y) && sc.GetPosition(x, y) == null)
            {
                if(sc.GetCheck(x, y) && ((sc.Getattackblack(x,y) < 0 && sc.GetCurrentPlayer() == "black") || (sc.Getattackwhite(x,y) <0 && sc.GetCurrentPlayer() == "white")))
                    MovePlateSpawn(x, y);
                x += xIncrement;
                y += yIncrement;
            }
    ...
    public void PointMovePlate(int x, int y)
    {
        ...
        if (sc.PositionOnBoard(x, y))
        {
            ...
            else if (sc.GetPosition(xBoard, yBoard).name == "white_knight" || sc.GetPosition(xBoard, yBoard).name == "black_knight")
            {
                ...
                }else if(sc.GetCheck(x, y) && ((sc.Getattackblack(x, y) < 0 && sc.GetCurrentPlayer() == "black") || (sc.Getattackwhite(x, y) < 0 && sc.GetCurrentPlayer() == "white")))
                {
                    if (cp == null)
                    {
                        MovePlateSpawn(x, y);
        ...
        else
        {
            if (sc.PositionOnBoard(x, y))
            {
                if (sc.GetPosition(x, y) == null)
                {
                    if (sc.GetCheck(x, y) && ((sc.Getattackblack(x, y) < 0 && sc.GetCurrentPlayer() == "black") || (sc.Getattackwhite(x, y) < 0 && sc.GetCurrentPlayer() == "white")))
                        MovePlateSpawn(x, y);
                    if (controller.GetComponent<Game>().GetCurrentPlayer() == "white" && whitehasmoved == 0 && sc.GetPosition(x, y + 1) == null && sc.GetCheck(x, y+1) && ((sc.Getattackblack(x, y+1) < 0 && sc.GetCurrentPlayer() == "black") || (sc.Getattackwhite(x, y+1) < 0 && sc.GetCurrentPlayer() == "white")))
                    {
                        MovePlateSpawn(x, y + 1);
                    }
                    else if (controller.GetComponent<Game>().GetCurrentPlayer() == "black" && blackhasmoved == 0 && sc.GetPosition(x, y - 1) == null && sc.GetCheck(x, y-1) && ((sc.Getattackblack(x, y-1) < 0 && sc.GetCurrentPlayer() == "black") || (sc.Getattackwhite(x, y-1) < 0 && sc.GetCurrentPlayer() == "white")))
                    {
                        MovePlateSpawn(x, y - 1);
                    }
                }

                if (sc.PositionOnBoard(x + 1, y) && sc.GetPosition(x + 1, y) != null && sc.GetPosition(x + 1, y).GetComponent<Chesspieces>().player != player && sc.GetCheck(x+1, y) && ((sc.Getattackblack(x+1, y) < 0 && sc.GetCurrentPlayer() == "black") || (sc.Getattackwhite(x+1, y) < 0 && sc.GetCurrentPlayer() == "white")))
                {
                    MovePlateAttackSpawn(x + 1, y);
                }
                ...
                if (controller.GetComponent<Game>().GetCurrentPlayer() == "white")
                {
                    if (sc.PositionOnBoard(x + 1, y - 1) && sc.GetPosition(x + 1, y - 1) != null && sc.GetPosition(x + 1, y - 1).GetComponent<Chesspieces>().player != player && sc.GetPosition(x + 1, y - 1).GetComponent<Chesspieces>().Isenpassant() && sc.GetCheck(x+1, y-1) && ((sc.Getattackblack(x+1, y-1) < 0 && sc.GetCurrentPlayer() == "black") || (sc.Getattackwhite(x+1, y-1) < 0 && sc.GetCurrentPlayer() == "white")))
                    {
                        if (sc.GetPosition(x + 1, y - 1).GetComponent<Chesspieces>().passantturn == sc.GetComponent<Game>().GetTurns())
                        {
                            MovePlateAttackSpawn(x + 1, y);
